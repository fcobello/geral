...
public class Engine implements Runnable
{
	...
	private Peca criaPecaPadrao()
	{
		...
		case 3:
			...
			break;
		case 4:
			peca.criaBloco(1, 1, Color.MAGENTA);
			peca.criaBloco(0, 2, Color.MAGENTA);
			peca.criaBloco(1, 2, Color.MAGENTA);
			peca.criaBloco(2, 2, Color.MAGENTA);//
			break;
		case 5:
			peca.criaBloco(0, 0, Color.CYAN);
			peca.criaBloco(0, 1, Color.CYAN);
			peca.criaBloco(1, 1, Color.CYAN);
			peca.criaBloco(1, 2, Color.CYAN);
			break;
		case 6:
